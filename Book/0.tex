...
\medskip\noindent
The book is also available as a PDF \url{https://github.com/simonjohnthompson/haskellcraft/blob/main/Book/root.pdf} as a part of the repository for the source code for the text \url{https://github.com/simonjohnthompson/haskellcraft/}.
} % end beware
