...
All the programs and examples used in the text can be downloaded as the \texttt{Craft3e} package from Cabal and from the book's GitHub repository,
\begin{center}
\label{bookWeb}
\url{https://github.com/simonjohnthompson/haskellcraft}
\end{center}\minx{github.com/simonjohnthompson/haskellcraft}\index{website}
