...
GHCi comes as a part of the \textbf{Haskell Platform} \cite{HaskellPlatform},\index{Haskell Platform} a standard distribution of the compiler and a selection of commonly-used libraries. Other libraries are available from an extensive online database, \textbf{HackageDB}\index{HackageDB} \cite{Hackage}. The \textbf{Cabal}\index{Cabal} \cite{Cabal} packaging and distribution infrastructure, which comes as part of the Haskell Platform, makes it easy to download and install these libraries. We describe how to work with the interactive version of GHC in the next chapter, and  how to use Hackage and Cabal in Chapter \ref{progLists}.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=5in]{Pictures/ScreenSVG.pdf}
\end{center}
