...
%\usepackage{array}
%\begin{document}\input{defs0}\input{miradefs}\setcounter{chapter}{9}\setcounter{page}{157}
...
\begin{center}
\mbox{\includegraphics[height=1.5cm]{Pictures/mult1.pdf}}
\end{center}
...
\begin{alltt}
\textsl{Prompt>} quickCheck (prop\_mf (>0) (\bs{}x -> x*x))

\textsl{+++ OK, passed 100 tests.}

\textsl{Prompt>} quickCheck (prop\_mf (>=0) (\bs{}x -> x*x*x))
