...
%\usepackage{array}
%\begin{document}\input{defs0}\input{miradefs}\setcounter{chapter}{11}\setcounter{page}{201}
...
of their major features. Full details of the base classes are given in the Haskell 2010 report \cite{haskell2010}, and their dependencies are illustrated in Figure \ref{ClassesDiagram}, adapted from the Haskell 2010 report.
...
\begin{figure}[t]
\begin{center}
\includegraphics[width=3.5in]{Pictures/Base-classes.png}
\end{center}
\caption{The Haskell standard classes\protect\footnotemark}
\label{ClassesDiagram}\index{Haskell!Base classes diagram}\index{classes!diagram for Haskell}
\end{figure}
\footnotetext{By Leftaroundabout - Own work, CC BY-SA 4.0, \url{https://commons.wikimedia.org/w/index.php?curid=63712544}}
...
\beware{\texttt{Functor}, \texttt{Monad} and friends}{
We talk about the classes in the lower block in the diagram, including \texttt{Functor} and \texttt{Monad}, in Chapter \ref{actions}.
}
