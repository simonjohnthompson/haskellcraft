...
\end{alltt}
An element of this type is either a leaf, or it's a node with a left subtree, a value of type \texttt{a}, and a right subtree. What do we do to apply \texttt{f} to everything of type \texttt{a} in the tree? 
\begin{alltt}
...
instance Applicative Tree where
  ...
  liftA2 f (Node t1 x t2) (Node s1 y s2) =
    Node (liftA2 f t1 s1)
         ...
         (liftA2 f t2 s2)
\end{alltt}
Let's look at the \texttt{Leaf} cases first.
