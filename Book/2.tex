...
The best, and easiest, way of working with Haskell is to install it on your own computer, and this you do using GHCup, \url{https://www.haskell.org/ghcup/}, as shown in Figure \ref{GHCup}.

\begin{figure}[t] 
\begin{center}
\includegraphics[width=12cm]{Pictures/GHCup.png}
\end{center} 
\caption{The GHCup homepage}
\label{GHCup}
\end{figure}

GHCup will install Haskell, as well as some other components and GHCi are available stand alone, but they also come as part of the \textbf{Haskell Platform}\index{Haskell Platform}. In addition to GHC and GHCi, this contains a selection of standard libraries and tools for Haskell. Included in the tools is \texttt{cabal},\index{Cabal} a package for distributing Haskell code and libraries, and which we use for distributing the code for the book; we come back to  \texttt{cabal} in Chapter \ref{progLists}.
