...
We will come back to \texttt{cabal} and HLS when we discuss multi-file projects BELOW. ADD.
We come back to \texttt{cabal} in Chapter \ref{progLists}. CHECK THIS
...
We will say more about this once we have introduced Haskell
modules, which we do now.

ADD CROSS REF Chapter \ref{progLists} for details????
...
\caption{GHCi, Prelude and other modules}
