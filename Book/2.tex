...
If you're learning Haskell in high school or college, or at work, your teachers or colleagues will have made sure it is available on the computers you use. If you want to install it for yourself on a machine that you control, the best, and easiest, way of working doing that is to use \href{https://www.haskell.org/ghcup/}{GHCup}.
...
The GHCup webpage has \href{https://www.haskell.org/ghcup/steps/}{documentation about `first steps'}\index{GHCup!first steps} in getting started, covering \texttt{ghci} after a short introduction to the \texttt{ghc} command itself.
The \href{https://downloads.haskell.org/ghc/latest/docs/users_guide/}{full documentation for the Glasgow Haskell Compiler}\index{GHCi!documentation} includes information specifically about GHCi, too.
...
These libraries are available on \href{https://hackage.haskell.org}{\emph{Hackage}},\index{Hackage} the main online package repository for Haskell, using the Cabal installation system.
...
The code for this text is available \href{https://hackage.haskell.org/package/Craft3e}{on Hackage}.
...
Alternatively, if you are familiar with git and github, you can obtain the code from the \href{https://github.com/simonjohnthompson/haskellcraft}{github repository} by cloning it. As well as the code, this repository contains the source code for the book itself, and other miscellaneous material.
...
The running example in Chapter \ref{intro} was of pictures, and we saw there that there are two implementations of these functions, one in \texttt{Pictures.hs} giving an `ASCII art' version, and the other in \texttt{PicturesSVG.hs} rendering pictures in a web browser.\minx{PicturesSVG}\label{ShowBrowser}
\begin{itemize}
\item
