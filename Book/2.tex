...
If you're learning Haskell in high school or college, or at work, your teachers or colleagues will have made sure it is available on the that computers you use. If you want to install it for yourself on a machine that you control, the best, and easiest, way of working doing that is to use GHCup, \url{https://www.haskell.org/ghcup/}.
...
GHCup\index{GHCup} will install Haskell, as well as some other components including \texttt{cabal},\index{Cabal} a package for distributing Haskell code and libraries, and one of the ways that you can access  the code for the book; we come back to \texttt{cabal} in Chapter \ref{progLists}.
...
To start GCHi in a terminal on macOS, Linux and WSL, type \texttt{ghci}\minx{ghci}
