...
GHCup will install Haskell, as well as some other components including \texttt{cabal},\index{Cabal} a package for distributing Haskell code and libraries, and one mechanism that we use for distributing the code for the book; we come back to \texttt{cabal} in Chapter \ref{progLists}.
\index{downloading support materials} 

Other ways of using Haskell -- such as using it online or in a browser -- can be found in Appendix \ref{OtherHS}; we discuss how to find out more about the functions and libraries in Haskell in Chapter \ref{progLists}. DOUBLE BACK TO THIS


\begin{figure}[t] 
\begin{center}
\includegraphics[width=12cm]{Pictures/ghci-terminal.png}
\end{center} 
...
\ref{GHCiSession},
because this is common to Windows, Mac OS X and Linux. 
