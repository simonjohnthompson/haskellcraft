...
Haskell home page, \url{https://www.haskell.org/}.
...
found on the web. This text itself has a home page at \url{https://github.com/simonjohnthompson/haskellcraft}.
The Haskell home page, Figure \ref{HaskellDotOrg}, is at \url{https://www.haskell.org/},
...
The Haskell community includes online forums (Discourse, IRC, mailing lists), news (Reddit), blogging (Planet Haskell) and help (Stack Overflow). The \emph{Haskell Weekly} newsletter and podcast, \url{https://haskellweekly.news/}, gives a regular summary of Haskell-related software releases, blog entries and other news, and is syndicated to Planet Haskell.
...
Haskell B.!biography}
\url{https://mathshistory.st-andrews.ac.uk/Biographies/Curry/}.
...
of Functional Programming}, \url{https://jfp.episciences.org/},
and at the annual
International Conference in Functional Programming, \url{https://www.icfpconference.org/}.
Each year there is a one-day symposium devoted to research in Haskell, \url{https://www.haskell.org/haskell-symposium/},
