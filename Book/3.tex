...
2147483647
\end{alltt} 
Integers in the \texttt{Integer} type can be as large as you wish: looking back at the GHCi screenshot in Figures \ref{GHCiSession} you can see examples of this. We do arithmetic on integers using the following operators and functions.
...
\ttfamily acos asin atan & \ttfamily Float -> Float & The inverse of cosine, sine and tangent.\\
\ttfamily ceiling floor round & \ttfamily Float -> Integer & Convert a fraction to an integer by rounding up, down, or to the closest integer.\\
\ttfamily cos sin tan & \ttfamily Float -> Float &  Cosine, sine and tangent.\\
...
notation, it will be written as \texttt{1.162433e+143}.
