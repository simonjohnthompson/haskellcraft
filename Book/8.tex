...
{In fact the choice of the first move in defining \texttt{echo} is not completely arbitrary: men are most likely to choose \texttt{Rock} first. This and lots more information about Rock - Paper - Scissors can be found at the World Rock Paper Scissors Association website, \url{https://wrpsa.com}.
}
