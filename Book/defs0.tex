...
% \inso/\inst switch to typewriter font with the underscore catcode
% changed to 12 (disabling its special interpretation under TeX), so
% Miranda/Haskell identifiers with underscores can be typed literally
% inline. Displayed code uses plain alltt directly; the former
% \so/\st/\stt/ttdisplay wrapper around it added nothing any current
% listing needed and is gone.
...
% obeyspaces macro, and so by any alltt-based display or \inso/\inst use.
