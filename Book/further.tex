...
This example shows how the problem solving approach applies in Haskell, and how it can help you get started on a problem which at first looks more complicated than it turns out to be. An \href{http://www.cs.kent.ac.uk/people/staff/sjt/Haskell_craft/Palin.hs}{executable version of the program} is available online.
