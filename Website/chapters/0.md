...
>
> This is a work in progress. In particular [Abstraction: functors, monads and folding](18.5.md#actions) is still being revised.
...
[Playing the game: I/O in Haskell](8.md#io) shows how simple terminal IO is handled in Haskell: to do this the `do` notation for writing programs of type `(IO a)` is introduced as an extension of Haskell's syntax, with the explanation of what underlies it being postponed to [Abstraction: functors, monads and folding](18.5.md#actions), where monads are covered. An interactive version of the Rock - Paper - Scissors game is used to illustrate IO in practice.
