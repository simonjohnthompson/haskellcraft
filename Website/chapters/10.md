...
3.  For the purposes of this exercise you should use `foldr` to give definitions of the prelude functions `unZip`, `last` and `init`, where examples of the latter two are given by<a id="ix-10-peccary-greggery"></a>
