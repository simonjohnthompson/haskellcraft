...
### Partially applied operators: operator sections {#partially-applied-operators-operator-sections .unnumbered}
...
2.  Find operator sections `sec1` and `sec2` so that
...
6.  A function `f` is called **idempotent** if<a id="ix-11-idempotence"></a>
