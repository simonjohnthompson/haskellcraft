...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/compos.png" alt="Function composition" style="width:3in"><span class="img-wrapper"><img src="Pictures/compos.png" alt="Function composition"></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/composType.png" alt="" style="width:3.5in"><span class="img-wrapper"><img src="Pictures/composType.png" alt=""></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/comp2.png" alt="Plumbing `f` and `g` together." style="width:4in"><span class="img-wrapper"><img src="Pictures/comp2.png" alt="Plumbing `f` and `g` together."></span></label>
...
3.  Given a function `f` of type `a -> b -> c`, write down a lambda abstraction that describes the function of type `b -> a -> c` which behaves like `f` but which takes its arguments in the other order. Pictorially,
    ...
    <label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/flip.png" alt="" style="width:3.4in"><span class="img-wrapper"><img src="Pictures/flip.png" alt=""></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/mult2.png" alt="" style="height:1.5cm"><span class="img-wrapper"><img src="Pictures/mult2.png" alt=""></span></label>

What happens if `multiply` is applied to **one** argument `2`? Pictorially, we have

<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/mult3.png" alt="" style="height:1.5cm"><span class="img-wrapper"><img src="Pictures/mult3.png" alt=""></span></label>
...
>
> <label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/arrowDiags.png" alt="" style="width:3.0in"><span class="img-wrapper"><img src="Pictures/arrowDiags.png" alt=""></span></label>
>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/curry.png" alt="" style="width:3in"><span class="img-wrapper"><img src="Pictures/curry.png" alt=""></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/uncurry.png" alt="" style="width:3.0in"><span class="img-wrapper"><img src="Pictures/uncurry.png" alt=""></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/mapComp.png" alt="" style="width:3.5in"><span class="img-wrapper"><img src="Pictures/mapComp.png" alt=""></span></label>
