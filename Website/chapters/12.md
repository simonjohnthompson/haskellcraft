...
but `(..3)` has the disadvantage that it is substantially less efficient than `(..2)`, a topic we pick up in [Time and space behaviour](21.md#behaviour).
...
We return to a fuller discussion of program behaviour in [Time and space behaviour](21.md#behaviour).
