...
7.  In the light of the discussion in the last four chapters, redo the exercises of [Extended exercise: positioned pictures](6.md#posPix), which deal with positioned pictures.
...
4.  Can you use the function `sTossList` to give another definition of the `randomStrategy` strategy first defined in [Rock - Paper - Scissors: strategies](8.md#strategiesRPS)?
