...
<figure id="treeFig2"><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/NewTwoTrees.png" alt="Two trees." style="width:3in"><span class="img-wrapper"><img src="Pictures/NewTwoTrees.png" alt="Two trees."></span></label><figcaption>Two trees.</figcaption></figure>
...
<figure id="associate"><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/Associate.png" alt="Rearranging additions" style="width:3in"><span class="img-wrapper"><img src="Pictures/Associate.png" alt="Rearranging additions"></span></label><figcaption>Rearranging additions</figcaption></figure>
...
<figure id="either"><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/either1.png" alt="Joining together functions." style="width:3in"><span class="img-wrapper"><img src="Pictures/either1.png" alt="Joining together functions."></span></label><figcaption>Joining together functions.</figcaption></figure>
...
<figure id="errPic"><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/maybe1.png" alt="Error-handling functions." style="width:5in"><span class="img-wrapper"><img src="Pictures/maybe1.png" alt="Error-handling functions."></span></label><figcaption>Error-handling functions.</figcaption></figure>
...
> ```
>
> To be checkable, we need to be able to generate random values of the types `Expr`, `NTree` and `Tree a` (for types `a` for which random values can be generated). We have done this in the module available online, and we will explain the code in more detail in [Domain-Specific Languages](20.md#dsls).
