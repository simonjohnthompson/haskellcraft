...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/FishChips.png" alt="" style="float:left; margin:0 1em 0.5em 0; width:4cm"><span class="img-wrapper"><img src="Pictures/FishChips.png" alt=""></span></label>
