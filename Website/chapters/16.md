...
When is a tree ordered? The tree (Node val  ) is ordered if

-   all values in `` are smaller than `val`,

-   all values in `` are larger than `val`, and

-   the trees `` and `` are themselves ordered;
