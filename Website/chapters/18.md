...
where recall that ` -> e` is the function which takes the parameter `x` to result `e`, so here the parameter is called `line`, and used just as above. More complex examples are translated in a similar way.
...
![](Pictures/Monad5.png){height="1.2cm"}

to give

![](Pictures/Monad6.png){height="1.2cm"}
...
![Replacing the elements of a tree with natural numbers.](Pictures/TreeBefore.png "fig:"){height="6cm"} ![Replacing the elements of a tree with natural numbers.](Pictures/TreeAfter.png "fig:"){height="6cm"}
