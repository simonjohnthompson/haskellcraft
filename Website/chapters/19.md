...
The laws are much clearer when stated in terms of a derived operator, `>=>`, pronounced 'fish', that is defined in `Control.Monad`: <a id="ix-19-se36849"></a>
...
<div class="center">
<p><embed src="Pictures/TreeBefore.png" style="height:6cm" /> <embed src="Pictures/TreeAfter.png" style="height:6cm" /></p>
</div>
<div id="treeTrans">

</div>
<figcaption>Replacing the elements of a tree with natural numbers.</figcaption>
</figure>
...
[^2]: [wiki.haskell.org/Foldable_and_Traversable](wiki.haskell.org/Foldable_and_Traversable){.uri}
