...
<figcaption>Principal GHCi commands<a id="commands"></a></figcaption>
...
As well as the standard libraries, there is a wealth of contributed libraries that support property-based testing, concurrency, functional animations and so forth; we will introduce the libraries that we need as we go along. These libraries are available on *Hackage*,<a id="ix-2-hackage"></a> <https://hackage.haskell.org>, the main online package repository for Haskell, using the Cabal installation system. We will say something more about Cabal in [Working with multiple-module projects](#multipleModuleProgs) and give an overview of more Haskell modules and libraries in [Programming with lists](6.md#progLists).
...
<figure id="GHCiPreludeModules"><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/GHCiLibPrel.png" alt="GHCi, the Prelude and other modules" style="width:4in"><span class="img-wrapper"><img src="Pictures/GHCiLibPrel.png" alt="GHCi, the Prelude and other modules"></span></label><figcaption>GHCi, the Prelude and other modules</figcaption></figure> <a id="ix-2-ghci-modules-in"></a>
