...
 <label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/Platform.png" alt="" style="float:left; margin:0 1em 0.5em 0"><span class="img-wrapper"><img src="Pictures/Platform.png" alt=""></span></label>
