...
As well as the standard libraries, there is a wealth of contributed libraries that support property-based testing, concurrency, functional animations and so forth; we will introduce the libraries that we need as we go along. These libraries are available on *Hackage*,<a id="ix-2-hackage"></a> <https://hackage.haskell.org>, the main online package repository for Haskell, using the Cabal installation system. We will say more about this once we have introduced Haskell modules, which we do now.

ADD CROSS REF [Programming with lists](6.md#progLists) for details????
...
<figure><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/GHCiLibPrel.png" alt="GHCi, Prelude and other modules" style="width:4in"><span class="img-wrapper"><img src="Pictures/GHCiLibPrel.png" alt="GHCi, Prelude and other modules"></span></label><figcaption>GHCi, Prelude and other modules</figcaption></figure>
