...
which lists all the links given here. The Haskell home page, Figure [The Haskell home page, www.haskell.org](#HaskellDotOrg), is at
...
LISP is the oldest established functional language, but it differs from Haskell and SML in not being strongly typed. An excellent tutorial introduction to programming in the Scheme dialect of LISP is given in . *Land of Lisp* ([Barski 2010](bibliography.md#LandOfLisp)) is a book, website and music video[^1] introducing Lisp by developing a series of games.
