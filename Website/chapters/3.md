...
|:------------------------------------------|:-------|
| tab                                       | `’\t’` |
| newline <a id="ix-3-tab-t"></a>                   | `’\n’` |
| backslash (`\`) <a id="ix-3-newline-n"></a>       | `’\’`  |
| single quote (`’`) <a id="ix-3-backslash"></a>    | `’\’’` |
| double quote (`"`) <a id="ix-3-single-quote"></a> | `’\"’` |

<a id="ix-3-double-quote"></a>
...
<figcaption>Floating-point operations and functions.</figcaption><a id="numOps"></a>
