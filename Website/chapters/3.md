...
Integers in the `Integer` type can be as large as you wish: looking back at the GHCi screenshots in [A GHCi session in Mac OS X](2.md#GHCiSessionMac) and [A WinGHCi session in Windows XP](2.md#WinGHCiSession) you can see examples of this. We do arithmetic on integers using the following operators and functions.
