...
**5.17** What is the result of evaluating `[2 .. 2]`? What about `[2,7 .. 4]`? Try evaluating `[2,2 .. 2]`; to **interrupt evaluation**<a id="ix-5-evaluation-interrupt"></a> in GHCi under Windows or Unix you need to type `Ctrl-C`.
