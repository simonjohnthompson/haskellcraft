...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/lineSoln.png" alt="" style="width:3in"><span class="img-wrapper"><img src="Pictures/lineSoln.png" alt=""></span></label>
...
7.  The type `Shape` takes no account of the position or orientation of a shape. After deciding how to represent points, how would you modify the original definition of `Shape` to contain the **centre** of each object? You can assume that rectangles lie with their sides parallel to the axes, thus:
    ...
    <label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/rectanglePos.png" alt="" style="width:3in"><span class="img-wrapper"><img src="Pictures/rectanglePos.png" alt=""></span></label>
...
8.  Calling the new shape type `NewShape`, define a function
    ...
    <label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/rectangleMove.png" alt="" style="width:3.5in"><span class="img-wrapper"><img src="Pictures/rectangleMove.png" alt=""></span></label>
