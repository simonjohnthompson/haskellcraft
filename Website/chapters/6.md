...
As well as the polymorphic functions in Figure [Some polymorphic list operations from Prelude.hs.](#polyListOps), the standard prelude provides various operations over specific types; some of these can be seen in Figure [Some monomorphic list operations from the Prelude.](#monoListOps). The types of the functions `sum` and `product`, which are overloaded, will be discussed further in [Overloading, type classes and type checking](13.md#typeClasses).
...
An example, in which we position the `horse` with its bottom left-hand corner or **reference point** at position `(31,23)`, is given in Figure [An example Image.](#horsePos).
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/Cards.png" alt="" style="float:right; margin:0 0 0.5em 1em; width:5cm"><span class="img-wrapper"><img src="Pictures/Cards.png" alt=""></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/NESW.png" alt="" style="float:right; margin:0 0 0.5em 1em; width:2cm"><span class="img-wrapper"><img src="Pictures/NESW.png" alt=""></span></label>
...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/Hand1.png" alt="" style="float:right; margin:0 0 0.5em 1em; width:3cm"><span class="img-wrapper"><img src="Pictures/Hand1.png" alt=""></span></label>
