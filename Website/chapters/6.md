...
>
> Full documentation for Cabal is [available online](https://cabal.readthedocs.io/).
...
: <a id="ix-6-documentation-prelude"></a>
  ...
  In particular, documentation for the `Prelude`, including descriptions of and examples for many of the functions, is part of the documentation for the `base` package, and is [available directly online](https://hackage.haskell.org/package/base/docs/Prelude.html), always pointing to the documentation for whichever version of `base` ships with the current release of GHC.

Hackage

: <a id="ix-6-documentation-hackage"></a>

  Haddock documentation is available for the great majority of packages on Hackage. This is accessible from [Hackage's package listing](https://hackage.haskell.org/package/), browsable by category, but also searchable. A typical package page is shown in [The HackageDB description of the accelerate package](#HackagePic): documentation for the modules making up the package is linked from the list of modules below the **Modules** header, towards the bottom of the page; an example is shown in [Haddock documentation for the accelerate package](#Haddock).
...
: <a id="hoogle"></a>
  ...
  [Hoogle](https://hoogle.haskell.org/) allows you to search many of the standard and Hackage libraries: what is cool about Hoogle is that you can **search by type** as well as by name. Narrowing down a search by type can lead you very quickly to your answer, or at least eliminate a lot of "noise" in a search. See [Hoogle in action](#Hoogle) for example results. Be aware, though, that Hoogle doesn't cover every package on Hackage. A general web search -- even using a type signature as the search text -- is also often surprisingly effective.
