...
:   <a id="ix-6-documentation-hackage"></a>
    ...
    Haddock documentation is available for the great majority of packages on Hackage. This is accessible from <https://hackage.haskell.org/package/>, which is listed by category, but also searchable. A typical package page is shown in [The HackageDB description of the agum package](#HackagePic): documentation for the modules making up the package is linked from the list of modules below the **Modules** header, towards the bottom of the page; an example is shown in [Haddock documentation for the agum package](#Haddock).
