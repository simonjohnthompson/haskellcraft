...
<figure><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/list1.png" alt="" style="height:1cm"><span class="img-wrapper"><img src="Pictures/list1.png" alt=""></span></label></figure>\
is to sort the tail `[3,9,2]` to give\
<figure><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/list2.png" alt="" style="height:1cm"><span class="img-wrapper"><img src="Pictures/list2.png" alt=""></span></label></figure>\
It is then a matter of inserting the head, `7`, in the right place in this list, to give the result\
<figure><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/list3.png" alt="" style="height:1cm"><span class="img-wrapper"><img src="Pictures/list3.png" alt=""></span></label></figure>\
...
<figure><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/list4.png" alt="" style="height:1cm"><span class="img-wrapper"><img src="Pictures/list4.png" alt=""></span></label></figure>\
...
<figure><label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/list5.png" alt="" style="height:1cm"><span class="img-wrapper"><img src="Pictures/list5.png" alt=""></span></label></figure>\
