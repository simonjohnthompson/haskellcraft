...
We can see the case switching and extracting components in action together in the definition of the function to give the `area` of a `Shape`, first seen in [areaDef](5.md#areaDef):
