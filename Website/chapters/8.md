...
One approach, taken in Standard ML ([Milner et al. 1997](bibliography.md#defsml2e)) and F# ([Smith 2009](bibliography.md#Fsharp)), for instance, is to include operations like
