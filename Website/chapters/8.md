...
: We can make a random choice of play.
  ...
  This isn't really a proper function, in fact, because it doesn't always return the same result, we should program this using monads, as described in [Abstraction: functors, monads and folding](18.5.md#actions). However, a little bit of 'under the hood' work allows us to fake this in Haskell; the details are in the code for this chapter. We'll discuss the full implementation in [Further I/O](18.md#furtherIO).
...
**8.9** \[Hard\] Can you use the facilities of QuickCheck -- described in more detail in [DSLs for computation: generating data in QuickCheck](19.md#qcGens) -- to help to analyse what an arbitrary strategy does?
...
In this chapter we introduce the basics of I/O using the `IO` types; [Abstraction: functors, monads and folding](18.5.md#actions) describes the *monadic* approach to programming which underlies I/O and other forms of interaction with the 'world outside'.
