...
1.  Prove the properties for functions over `Picture` first discussed in [Tests, properties and proofs](1.md#proof), that is, for all finite `pic`:
...
2.  Look again at the properties for functions over `Picture` discussed in [The Picture example: implementation](6.md#picturesAgain), and prove those properties which should hold for all pictures.
