...
<label class="checkbox-label"><input class="checkbox-img" type="checkbox"><img src="Pictures/reverseSwap.png" alt="Reversing the list `xs++ys`" style="width:2.5in"><span class="img-wrapper"><img src="Pictures/reverseSwap.png" alt="Reversing the list `xs++ys`"></span></label>
