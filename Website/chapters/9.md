...
2.  Look again at the properties for functions over `Picture` discussed in [picturesAgain](6.md#picturesAgain), and prove those properties which should hold for all pictures.
