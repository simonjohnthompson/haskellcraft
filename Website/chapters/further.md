...
This section is a worked example of the problem solving process, applied to writing a Haskell function which recognises palindromes -- strings which read the same backwards and forwards, such as
...
This example shows how the problem solving approach applies in Haskell, and how it can help you get started on a problem which at first looks more complicated than it turns out to be. An executable version of the program is available at <http://www.cs.kent.ac.uk/people/staff/sjt/Haskell_craft/Palin.hs>.
